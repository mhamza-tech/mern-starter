...
export class ChatRoomRemovePlayerEidsUniqueConstraint1573852484608 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('CREATE TYPE "edge_thisentitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "edge_thatentitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "effect_entitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "newsfeed_item_entitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "comment_entitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "comment_receipt_entitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "receipt_entitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "field_entitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "field_thisentitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "chat_room_entitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE TYPE "notification_entitytype_enum" AS ENUM(\'Activity\', \'UnObject\', \'User\', \'NewsfeedItem\', \'Field\', \'Comment\', \'DeviceInfo\', \'ChatRoom\', \'Notification\', \'CommentReceipt\', \'Receipt\', \'Effect\', \'CompletedAction\')')
    ...
    await queryRunner.query('CREATE INDEX "IDX_127bd3b4c945e62ae2d50591ce" ON "chat_room" ("playerEids") ')
  }

  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('DROP INDEX "IDX_127bd3b4c945e62ae2d50591ce"')
    await queryRunner.query('CREATE TYPE "notification_entitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    await queryRunner.query('ALTER TABLE "notification" ALTER COLUMN "entityType" DROP DEFAULT')
    ...
    await queryRunner.query('CREATE TYPE "chat_room_entitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    await queryRunner.query('ALTER TABLE "chat_room" ALTER COLUMN "entityType" DROP DEFAULT')
    ...
    await queryRunner.query('CREATE TYPE "field_thisentitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    ...
    await queryRunner.query('CREATE TYPE "field_entitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    await queryRunner.query('ALTER TABLE "field" ALTER COLUMN "entityType" DROP DEFAULT')
    ...
    await queryRunner.query('CREATE TYPE "receipt_entitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    await queryRunner.query('ALTER TABLE "receipt" ALTER COLUMN "entityType" DROP DEFAULT')
    ...
    await queryRunner.query('CREATE TYPE "comment_receipt_entitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    await queryRunner.query('ALTER TABLE "comment_receipt" ALTER COLUMN "entityType" DROP DEFAULT')
    ...
    await queryRunner.query('CREATE TYPE "comment_entitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    await queryRunner.query('ALTER TABLE "comment" ALTER COLUMN "entityType" DROP DEFAULT')
    ...
    await queryRunner.query('CREATE TYPE "newsfeed_item_entitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    await queryRunner.query('ALTER TABLE "newsfeed_item" ALTER COLUMN "entityType" DROP DEFAULT')
    ...
    await queryRunner.query('CREATE TYPE "effect_entitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    await queryRunner.query('ALTER TABLE "effect" ALTER COLUMN "entityType" DROP DEFAULT')
    ...
    await queryRunner.query('CREATE TYPE "edge_thatentitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
    ...
    await queryRunner.query('CREATE TYPE "edge_thisentitytype_enum_old" AS ENUM(\'Activity\', \'ChatRoom\', \'Comment\', \'CommentReceipt\', \'DeviceInfo\', \'Effect\', \'Field\', \'NewsfeedItem\', \'Notification\', \'Receipt\', \'UnObject\', \'User\')')
