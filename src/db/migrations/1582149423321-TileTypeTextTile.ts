...
export class TileTypeTextTile1582149423321 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('ALTER TYPE "public"."tile_type_enum" RENAME TO "tile_type_enum_old"')
    await queryRunner.query('CREATE TYPE "tile_type_enum" AS ENUM(\'ImageTile\', \'AnimationTile\', \'ActionTile\', \'TextTile\')')
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('CREATE TYPE "tile_type_enum_old" AS ENUM(\'ImageTile\', \'AnimationTile\', \'ActionTile\')')
