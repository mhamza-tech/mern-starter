...
export class ButtonField1589468145368 implements MigrationInterface {

  name = 'ButtonField1589468145368'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DROP INDEX "IDX_6871f24215af73672bcd4988db"', undefined)
    await queryRunner.query('DROP INDEX "IDX_c08ca407f9d2607d70900efd14"', undefined)
    await queryRunner.query('CREATE TYPE "field_type_enum_old" AS ENUM(\'ActionXEdgesField\', \'ActionXStubsField\', \'ActionsField\', \'AnimationField\', \'AvataaarField\', \'BooleanField\', \'ChatRoomIsTyping\', \'ChatRoomLastViewedAt\', \'CountdownField\', \'DateField\', \'EdgesField\', \'HashStatusField\', \'HashtributeField\', \'JSONObjectField\', \'NewsfeedItemCard\', \'NumberField\', \'PresenceField\', \'ProgressField\', \'StoryStatusField\', \'StringField\', \'TileField\', \'XpField\')', undefined)
