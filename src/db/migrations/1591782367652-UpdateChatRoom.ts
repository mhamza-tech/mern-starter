...
export class UpdateChatRoom1591782367652 implements MigrationInterface {

  name = 'UpdateChatRoom1591782367652'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DELETE from "edge" where "edgeType" in (\'ChatRoom\', \'ChatRoomPlayer\', \'ChatRoomPlayerHandler\')')
    await queryRunner.query('DELETE from "edge_stats" where "edgeType" in (\'ChatRoom\', \'ChatRoomPlayer\', \'ChatRoomPlayerHandler\')')
    ...
    await queryRunner.query('CREATE TYPE "edge_edgetype_enum" AS ENUM(\'Likes\', \'FriendRequest\', \'Friend\', \'Follows\', \'Actor\', \'UnObject\', \'NamedEdge\', \'ChatRoom\', \'ActionX\', \'Tile\', \'Interest\', \'Player\', \'NewsfeedItem\', \'Block\', \'ReactionEdge\')')
    ...
    await queryRunner.query('CREATE TYPE "edge_stats_edgetype_enum" AS ENUM(\'Likes\', \'FriendRequest\', \'Friend\', \'Follows\', \'Actor\', \'UnObject\', \'NamedEdge\', \'ChatRoom\', \'ActionX\', \'Tile\', \'Interest\', \'Player\', \'NewsfeedItem\', \'Block\', \'ReactionEdge\')')
    ...
    await queryRunner.query('CREATE TYPE "chat_room_type_enum" AS ENUM(\'PersonalPlayRoom\', \'SinglePlayRoom\', \'P2PChat\', \'MultiPlayRoom\')')
    await queryRunner.query('ALTER TABLE "chat_room" ADD "type" "chat_room_type_enum" NOT NULL DEFAULT \'PersonalPlayRoom\'')
    const chatRooms = await queryRunner.query('select "id", "playerEids" from "chat_room"')
    await Promise.all(chatRooms.map(chatRoom => {
      const segments = chatRoom.playerEids.split(',')
      if (segments[0].startsWith('unobject')) {
        return queryRunner.query(`update "chat_room" set "type" = 'SinglePlayRoom' where id = '${chatRoom.id}'`)
      } else if (segments.length === 1 && segments[0].startsWith('user')) {
        return queryRunner.query(`update "chat_room" set "type" = 'PersonalPlayRoom' where id = '${chatRoom.id}'`)
      }
      return queryRunner.query(`update "chat_room" set "type" = 'P2PChat' where id = '${chatRoom.id}'`)
    }))
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "chat_room" ADD "type" character varying NOT NULL DEFAULT \'ChatRoom\'')
    await queryRunner.query('CREATE TYPE "edge_stats_edgetype_enum_old" AS ENUM(\'ActionX\', \'Actor\', \'Block\', \'ChatRoom\', \'ChatRoomPlayer\', \'ChatRoomPlayerHandler\', \'Follows\', \'Friend\', \'FriendRequest\', \'Interest\', \'Likes\', \'NamedEdge\', \'NewsfeedItem\', \'Player\', \'ReactionEdge\', \'Tile\', \'UnObject\')')
    ...
    await queryRunner.query('CREATE UNIQUE INDEX "IDX_d497bdb63fa876ee87527963df" ON "edge_stats" ("entityId", "edgeDirection", "edgeType") ')
    await queryRunner.query('CREATE TYPE "edge_edgetype_enum_old" AS ENUM(\'ActionX\', \'Actor\', \'Block\', \'ChatRoom\', \'ChatRoomPlayer\', \'ChatRoomPlayerHandler\', \'Follows\', \'Friend\', \'FriendRequest\', \'Interest\', \'Likes\', \'NamedEdge\', \'NewsfeedItem\', \'Player\', \'ReactionEdge\', \'Tile\', \'UnObject\')')
    ...
    await queryRunner.query('CREATE INDEX "IDX_cc1a7f047ed28f91e6c5e55f91" ON "edge" ("edgeType", "collectionId") ')
  }
