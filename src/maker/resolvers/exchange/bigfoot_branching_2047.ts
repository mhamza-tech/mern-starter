...
import { config } from './mechanics/configs/bigfoot_branching_2047'

export const ID: NPCId = 'bigfoot_branching_2047'

//const logger = LoggerFactory('JoseAlt', 'NPC')

class BigFootBranching {
...
const npc = new BigFootBranching(config)
