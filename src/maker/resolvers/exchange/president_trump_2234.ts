...
import { config } from './mechanics/configs/president_trump_2234'

export const ID: NPCId = 'president_trump_2234'

//const logger = LoggerFactory('LoveDoctor', 'NPC')

class PresidentTrump {
...
const npc = new PresidentTrump(config)
